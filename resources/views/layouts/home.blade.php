...
<html lang="en">
  <head>
  <link rel="icon" type="images/png" href="logo/kayubae.png">
    <title>kayubae</title>
    <meta charset="utf-8">
          ...
          <div class="row d-md-flex no-gutters slider-text js-fullheight align-items-center justify-content-end" data-scrollax-parent="true">
	          ...
	          <div class="one-forth d-flex js-fullheight align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
	          	<div class="text">
		            ...
		            <p>Desain interior terbaik dan terlengkap sesuai pesanan anda.</p>
      ...
      <div class="slider-item js-fullheight">
        ...
        <div class="container">
          <div class="row d-flex no-gutters slider-text js-fullheight align-items-center justify-content-end" data-scrollax-parent="true">
	          ...
	          <div class="one-forth d-flex js-fullheight align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
	          	<div class="text">
		            <h1 class="mb-4">Kami Membuat Desain Arsitektur yang Menakjubkan</h1>
		            <p>Desain merupakan proses untuk membuat dan menciptakan objek baru yang bernilai estetika dan kreatif.</p>
		            <p><a href="#" class="btn btn-primary px-4 py-3 mt-3">View our works</a></p>
	            </div>
	          </div>
        	</div>
			...
			<div class="container">
	          ...
	          <div class="heading-section mb-5 pl-md-5">
	          	<div class="pl-md-5 ml-md-5">
		            ...
		            <h2 class="mb-4">Kami adalah Eksterior & Arsitektur terbaik &amp; Architecture Firm</h2>
	            </div>
	          </div>
	          <div class="pl-md-5 ml-md-5 mb-5">
							<p>Desain merupakan proses untuk membuat dan menciptakan objek baru yang bernilai estetika dan kreatif. Sebelum istilah desain grafis dikenal luas, orang-orang yang berkecimpung didunia grafika atau percetakan dan media mengenal istilah layouter sebagai orang yang bertugas menata letak huruf-huruf dan gambar pada bidang kertas cetak. </p>
						Sekarang ini banyak sekali peminat desain baik itu desain baju, desain logo, desain rumah bahkan desain pada kemasan suatu produk agar lebih menarik perhatian konsumen serta memiliki ciri khas sehingga dapat di bedakan antara.</p>
...
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5f32370a9af396d0"></script>
